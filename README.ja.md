...
作例枠は確保済みです。検証可能な原作リンク、または 079 原文プロンプトに直接照合した追加作例が揃い次第ここで優先表示し、別番号の画像や壊れたプレースホルダーで代用しません。

<!-- xxd-human-intro:start -->
## このスタイルが解決すること

一般的な「高級箔」は明るい黄色金属を表面に置くか、プラスチックの凸状にしがちで、圧縮された紙の静かな実在感を失います。

**Panel 079** は主体、空間、動作、関係を強い直線と自由な有機曲線で再構成し、原写真から少量の透明淡彩だけを加えます。広い紙白と未完成の探り線が、建築旅行スケッチの秩序と現場の手触りを両立します。

### 向いている用途

- 建築、人物、動植物、器物、乗り物、風景を、識別可能な上質な線形標章へ変換したい場合
- 主体の同一性、輪郭、構造、姿勢、関係を保ちながら、写実的な細部を削ぎ落としたい場合
- 自然紙、透明淡彩、墨線と未完成の探り線による静かな編集感を求める場合
...
| **入力の尊重** | 同一性、輪郭、構造、姿勢、関係を保ち、識別可能な繊細線へ簡略化する |
