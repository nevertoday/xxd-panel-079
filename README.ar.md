...
# 🦁 XXD Panel 079｜دفتر القلم والألوان الخفيفة

### يعيد الصورة كصفحة ملاحظة ميدانية بهيكل هندسي وحبر حر وتلوين مائي خفيف
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 079 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

تنسخ مرشحات تتبع الصور الحواف آلياً فحسب، بينما تميل مشاهد الألوان المائية المكتملة إلى ملء الخلفية حتى يثقل العنصر والفضاء والإيقاع التحريري معاً.

يعيد **Panel 079** بناء العنصر والفضاء والفعل والعلاقة بخطوط مستقيمة قوية ومنحنيات عضوية حرة، مع لمسات قليلة من ألوان مائية شفافة مأخوذة من الصورة. يحمل بياض الورق الواسع وخطوط البحث غير المكتملة مزيجًا من نظام اسكتش العمارة وخفة الرسم الميداني.

### مناسب لـ

- بناء فضاء العمارة والسفر والملاحظة الميدانية بأقوى الخطوط المستقيمة والانعطافات والمقاطع وعلاقات النسب؛
- إبقاء حيوية «الرسم غير المكتمل» عبر الخطوط الاستكشافية المكررة والانقطاعات والانزياحات الطفيفة والحواف المفتوحة؛
- أخذ اللون من الصورة من دون ملء اللوحة، ووضع تلوين شفاف قليل في المواضع الضرورية لترتيب الحبر واللون وبياض الورق؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 079 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** خطوط هندسية قوية · منحنيات عضوية حرة · حبر وتلوين مائي · إحساس غير مكتمل · بياض ورق واسع · تركيب تحريري للصورة والنص
...
|---|---|
| **الناتج** | صفحة ملاحظة تجمع هيكل الاسكتش المعماري وخفة الرسم الميداني وطباعة المجلة المستقلة |
| **البصمة الواضحة** | هيكل مستقيم قوي تكسره منحنيات حرة، مع تلوين قليل شفاف فوق بياض ورق واسع |
| **احترام المصدر** | يحفظ الهوية والمحيط والوضعيّة والفضاء والعلاقة السردية، ولا يأخذ اللون إلا من ألوان الأصل القابلة للتعرّف |
...
```text
استخلاص الهوية والبنية والفضاء والفعل والعلاقة → بناء هيكل بخطوط مستقيمة ومحاور هندسية → كسر النظام بمنحنيات عضوية وخطوط بحث → إضافة ألوان شفافة قليلة من الصورة → حذف الخلفية المعقدة وترك بياض واسع → وضع النص القليل على خطوط الهيكل والفراغ
```

## سمات النتيجة النهائية

- تبقى الخطوط رفيعة وغير متساوية مع آثار البحث والانقطاع والانزياح والحواف غير المكتملة.
- يقتصر التلوين على ألوان الصورة المميزة ويظل شفافًا مع إبقاء بياض الورق واسعًا.
- تُحذف الخلفية المعقدة ويحمل الفراغ الفضاء والمسافة.
- تتيح الإزاحة والقص الموضعي والامتداد إلى جانب واحد لبياض الورق الواسع أن يحمل السماء والهواء والمسافة والضوء والتوقف.
- يتبع المحرف التحريري الرفيع خطوط المنظور والمحاور وحواف العنصر أو الفراغ، بدلاً من قالب ثابت من عنوان ومتن.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-079-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 079. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-079 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-079 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-079 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-079 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-079 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 079 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-079 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-079`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-079-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-079-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ79 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 079 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–079) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
