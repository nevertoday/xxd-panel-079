...
```text
/xxd-panel-079 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，079 设计在下）
2. 左右对照（原图在左，079 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-079/<fresh-task>/
...
- `references/xxd-panel-079-prompt.zh-CN.md`
- `references/xxd-panel-079-prompt.en.md`
