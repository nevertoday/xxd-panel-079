...
예시 영역은 예약되어 있습니다. 검증 가능한 원작 링크나 079 원본 프롬프트와 직접 대조한 확장 예시가 준비되면 이곳에 먼저 표시하며, 다른 번호의 이미지나 깨진 자리표시자로 대신하지 않습니다.

<!-- xxd-human-intro:start -->
## 이 스타일이 해결하는 문제

흔한 ‘고급 금박’ 표현은 밝은 노란 금속을 표면에 얹거나 플라스틱 같은 볼록 장식으로 만들어, 눌린 종이가 지닌 조용한 실재감을 잃기 쉽습니다.
...
- 건축, 인물, 동식물, 사물, 교통수단, 풍경을 알아볼 수 있는 정교한 선형 표장으로 바꾸고 싶을 때
- 피사체의 정체성, 윤곽, 구조, 자세와 관계를 보존하면서 사실적 세부는 절제하고 싶을 때
- 자연스러운 종이, 투명 담채, 잉크선과 미완성 탐색선이 만드는 조용한 편집감을 원할 때
...
| **입력 존중 방식** | 정체성, 윤곽, 구조, 자세와 관계를 보존해 알아볼 수 있는 가는 선으로 단순화함 |
...
- 하나의 시각 중심과 넓고 고요한 여백을 유지합니다.
- 가늘고 현대적인 편집 서체를 도형과 같은 공정으로 종이 안에 압인합니다.
